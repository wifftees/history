const map = L.map('map').setView([55.75489633973109, 37.59364994442082], 5); 
  ...
  const solPopups = [
    ...
    `
      <div class="popup-content">
        <div class="popup-title">Цюрик</div>
        <div class="car">
          <div class="img-wrap">
              <img src="./resources/zurich_sol_1.jpg"
                  alt="1">
              <img src="./resources/moscow_sol_2.jpeg"
                  alt="2">
          </div>
        ...
        <div class="popup-text">
          Местоположение: район Шоссе Энтузиастов, бывший изолятор МВД
          <br><br>
          Контекст: после Лефортово его перевели в изолятор для подготовки к депортации. Ночевал одну ночь.
          <br><br>
          Условия: гораздо менее строгие, но находился под круглосуточной охраной.
          <br><br>
          Значение: финальное пребывание на территории СССР перед выдворением.
        </div>
      </div>
    `
  ]
